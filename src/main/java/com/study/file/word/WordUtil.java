 ...
 *
 * @date 2020-12-17
 * 参考   https://www.jb51.net/article/101910.htm
 */
public class WordUtil {
    ...
    public static void main(String[] args) {
        ...
        // 模板路径
        String tempPath = PathUtil.getSpecific("word") + "temp.doc";
        // 生成文件路径+名称
        String targetPath = PathUtil.getSpecific("word") + "zhangpba.doc";


        // 一 word文档内容读取
        String context = readDoc(tempPath);
        System.out.print("文档内容：" + context);
        // 二 word文档内容读取
        readDocByHwfd(tempPath);


        // 根据模板将数据写入word
        writeDoc(tempPath, targetPath);
    }
