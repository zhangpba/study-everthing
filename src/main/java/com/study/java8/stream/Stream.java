...
public class Stream {
    public static void main(String[] args) {
        ...
        System.out.println("java7空字符串数量为: " + count);
        ...
        System.out.println("java8平方数列表 : " + squaresList);

        List<Integer> integers = Arrays.asList(1, 2, 13, 4, 15, 6, 17, 8, 19);
        System.out.println("java7列表: " + integers);
        System.out.println("java7列表中最大的数 : " + getMax(integers));
        System.out.println("java7列表中最小的数 : " + getMin(integers));
        System.out.println("java7所有数之和 : " + getSum(integers));
        System.out.println("java7平均数 : " + getAverage(integers));
        ...
        for (int i = 0; i < 5; i++) {
            System.out.println("java7随机数：" + random.nextInt());
        }

        // java8产生随机数
        random.ints().limit(5).sorted().forEach(a -> System.out.println("java8随机数" + a));
